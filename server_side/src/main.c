...
void size_test() {
    ...
    struct database* test_database = database_get("select_size.bin", NEW);
    ...
    struct relation* relation_one = relation_create(schema_one, "test", test_database);
...
void save_test() {
    ...
    struct database* opened_database = database_get("save.bin", SAVED_IN_FILE);

    relation_one = relation_get("test", opened_database);
    ...
    relation_close(relation_one);
    database_close(opened_database);
}
...
void test_insert() {
    ...
    double elapsed_time;
    struct database* test_database = database_get("insert.bin", NEW);
...
void test_select() {
    ...
    struct database* test_database = database_get("select.bin", NEW);
...
void test_update() {
    ...
    struct database* test_database = database_get("update.bin", NEW);
...
void test_delete() {
    ...
    struct database* test_database = database_get("delete.bin", NEW);
...
void test_join() {
    ...
    struct database* test_database = database_get("db.bin", NEW);

    struct relation* relation_one = relation_create(schema_one, "first", test_database);
    struct relation* relation_two = relation_create(schema_two, "second", test_database);
